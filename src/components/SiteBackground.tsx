...
export default function SiteBackground() {
  ...
  return (
    ...
    >
      {/* 
        BASE LAYER
        Ultra-faint black/white dot matrix that is always visible
      */}
      <motion.div 
        initial={{ scale: 0.95 }}
        animate={{ scale: 1 }}
        transition={{ duration: 3, ease: "easeOut" }}
        className="absolute w-[140vw] h-[140vw] md:w-[122vw] md:h-[122vw] max-w-[2000px] max-h-[2000px] translate-x-[15%] md:translate-x-[12%] translate-y-[5%]"
      >
        <svg 
          viewBox="300 200 180 160" 
          className="w-full h-full text-slate-900 dark:text-slate-100 opacity-[0.06] dark:opacity-[0.08]"
        ...
        >
          <defs>
            ...
            <linearGradient id="trail-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <stop offset="100%" stopColor="#111827" className="dark:stopColor-white" />
            </linearGradient>
          </defs>
          <path 
            d={biharPath} 
            fill="url(#dot-matrix-base)"
            stroke="none" 
          />
          {/* Continuous Shiny Boundary Trail */}
          <path
            d={biharPath}
            fill="none"
            stroke="currentColor"
      ...
      {/* 
        HOVER GLOW LAYER
        Brighter dots that only appear near the mouse cursor via a CSS mask!
      */}
      <motion.div 
      ...
      >
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="absolute w-[140vw] h-[140vw] md:w-[122vw] md:h-[122vw] max-w-[2000px] max-h-[2000px] translate-x-[15%] md:translate-x-[12%] translate-y-[5%]">
            <svg 
              viewBox="300 200 180 160" 
              className="w-full h-full text-slate-900 dark:text-slate-100 opacity-[0.25] dark:opacity-[0.35]"
              preserveAspectRatio="xMidYMid meet"
            >
              <defs>
